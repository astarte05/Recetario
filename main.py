...
def bienvenida(message):
    texto = (
        ...
        "♡︎ Escribe los ingredientes que tienes separados por comas (ej: _zanahoria, almeja_).\n\n"
        "2️⃣ *Buscar recetas por platillo:*\n"
        "♡︎ Escribe el nombre de un platillo (ej: _macedonia_).\n\n"
        "3️⃣ *Ver recetas por categoría:*\n"
        "♡︎ Usa los siguientes comandos para ver recetas por tipo:\n"
        "     ʚ `/aperitivos` → Ver solo los aperitivos\n"
        "     ʚ `/entrantes1` → Ver solo los entrantes 1\n"
        "     ʚ `/entrantes2` → Ver solo los entrantes 2\n"
        "     ʚ `/postres1` → Ver solo los postres 1\n"
        "     ʚ `/postres2` → Ver solo los postres 2\n\n"
        "4️⃣ *Ver tipos de ingredientes:*\n"
        "♡︎ Usa el comando `/ingredientes` para conocer qué puedes combinar.\n\n"
